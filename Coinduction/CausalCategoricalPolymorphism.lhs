...
take a identity arrow as parameter:
...
There is a problem with this definition, since `id` is not
necessarily defined for all `a` (cf gadts)
...
how can i define abstract type in any category?
